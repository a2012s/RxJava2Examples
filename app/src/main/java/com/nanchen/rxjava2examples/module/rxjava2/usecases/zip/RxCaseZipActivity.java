...
public class RxCaseZipActivity extends RxOperatorBaseActivity {
    ...
    protected void doSomething() {
        Observable<MobileAddress> observable1 = Rx2AndroidNetworking.get("http://api.avatardata.cn/MobilePlace/LookUp?key=29f96b578bb04f23b44d20e6a012568f&mobileNumber=13021671512")
                .build()
